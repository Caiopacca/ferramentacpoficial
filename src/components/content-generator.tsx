    ...
    <div>
      <div className="text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mt-2">
            O Bizu e a Resenha são estrategistas de marketing, cariocas da gema, prontos para te ajudar. Prefere um papo reto e estratégico? Vá de Bizu. Quer uma ideia mais criativa e com um papo de resenha? A Resenha resolve.
          </p>
      </div>
